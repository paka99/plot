...
func TestLegendAlignment(t *testing.T) {
	...
	if *cmpimg.GenerateTestData {
		...
		err = ioutil.WriteFile("testdata/legendAlignment_golden.png", b.Bytes(), 0o644)
		if err != nil {
			t.Fatal(err)
		}
		return
	...
	err = ioutil.WriteFile("testdata/legendAlignment.png", b.Bytes(), 0o644)
	if err != nil {
		t.Fatal(err)
	}
	...
	ok, err := cmpimg.Equal("png", b.Bytes(), want)
	if err != nil {
		t.Fatal(err)
	}
	if !ok {
